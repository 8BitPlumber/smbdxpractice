...
; Game state 17
    ...
    ;ld   a,$31                     ; Load #31 into A
    ;ld   [$FFB5],a                 ; Set 0xFFB5 to #31
@Return:
    ret                             ; 00:0AE7
...
Code006969:
    ; Check if PlayerFireFlag is 01
ld   a,[W_PlayerFireFlag]
cp   $01                        ; Compare PlayerFireFlag with 01
jr   nz,CheckPlayerSize01       ; If not 01, skip to PlayerSize check
ld   a,$00                      ; Reset PlayerSize and PlayerFireFlag
ld   [W_PlayerSize],a
ld   [W_PlayerFireFlag],a
ret                             ; Return immediately

CheckPlayerSize01:
; Check if PlayerSize is 01
ld   a,[W_PlayerSize]
cp   $01                        ; Compare PlayerSize with 01
jr   nz,CheckPlayerSize00       ; If not 01, skip to next condition
ld   a,$01                      ; Set PlayerFireFlag to 01
ld   [W_PlayerFireFlag],a
ret                             ; Return immediately

CheckPlayerSize00:
; Check if PlayerSize is 00
ld   a,[W_PlayerSize]
cp   $00                        ; Compare PlayerSize with 00
jr   nz,ExitRoutine             ; If not 00, exit
ld   a,$01                      ; Set PlayerSize to 01
ld   [W_PlayerSize],a
...
Sub003D0D:
    ld   a,[W_TimerFrames]        ; 00:3D0D
    ldh  [<$FFA5],a                 ; 00:3D10
    ;ld   a,[W_LevelTimerHigh]       ; 00:3D12
    ;ldh  [<$FFA4],a                 ; 00:3D15
    call HexToDec8bit              ; 00:3D17
    ret                             ; 00:3D1A
